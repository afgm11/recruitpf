...
foreach($datausuario as $rowus)
{	
	$iduser=$rowus->iduser;
	$nomcompleto=$rowus->nomcompleto;
	$nomuser=$rowus->nuser; 
	$npass=$rowus->npass;
	$tpusuarios=$rowus->tpusuarios;
...
var valor_h=document.getElementById("username_org1").value;
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url();?>index.php/Usuarios/updateusuario" method="post" accept-charset="utf-8" name="frm">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre Completo</label>
                  <input type="text" class="form-control" name="nomcompleto" id="nomcompleto1" placeholder="Ingrese Nombre completo " value="<?php echo $nomcompleto?>">
                  <div id="error1"></div>
                </div>
                 <div class="form-group">
                  <label for="exampleInputEmail1">Nombre de Usuario</label>
                  <input type="text" class="form-control" name="username"  id="username1" placeholder="Ingrese nombre de usuario" onChange="validauser(1)" value="<?php echo $nomuser?>">
                  
                  <input type="hidden" class="form-control" name="username_org"  id="username_org1" value="<?php echo $nomuser?>">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="contrasegna" id="contraseña1" placeholder="Password" value="<?php echo $npass?>">
             <div id="error3"></div>
                </div>
              ...
              <!-- /.box-body -->
				<div class="form-group">
                  ...
                  <select class="form-control" id="tpusuario1" name="tpusuario" >
                   ...
                   <?php
				    foreach($listtpusuarios as $rowtpuser)
				    {
				   ?>
                    <option value="<?php echo $rowtpuser->idtpusuario ?>"
                    <?php
					
					if ($tpusuarios==$rowtpuser->idtpusuario){
                    ...
                    >
				   <?php echo $rowtpuser->nomtipo ?> </option>
                   <?php
				   	}
        ...
        <input type="checkbox" name="selpermiso<?php echo $x?>" id="selpermiso_<?php echo $x?>" onclick="marcaropc(1,<?php echo $x?>)"
        <?php
		if ($rowmenu1->opcionexis>=1){
			echo "checked";
       ...
       <?php
		...
		?> /></td>
              ...
              <input type="hidden" name="idusuario" id="idusuario1" value="<?php echo $iduser ?>">
                <button type="button" class="btn btn-primary" onClick="valdatosguardar(1)">Guardar</button>
                <a href="<?php echo base_url();?>index.php/usuarios/listado" class="btn btn-primary" >Volver</a>
              </div>
               </div>
            </form>
          </div>
